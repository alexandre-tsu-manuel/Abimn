...
namespace Abimn
{
    public static class Tile
    {
        ...
        public static void Draw(string path, Pos pos, float rotation = 0, float scale = 1)
        {
            if (path != "" && path != null)
                G.spriteBatch.Draw(Ressources.GetImage(path), pos.ToVector2(), null, Color.White, rotation, new Vector2(), scale, SpriteEffects.None, 0);
        }
    }
}
